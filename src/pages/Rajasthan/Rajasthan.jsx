...
import tourData from '../../data/RajasthanData.json';

const defaultDestinationData = {
  title: 'Rajasthan Tour Package',
  location: 'Rajasthan, India',
  duration: 'Duration not specified',
  description: 'Experience the royal heritage of Rajasthan with our exclusive tour packages',
  price: 0,
  quota: 0,
...
export default function RajasthanTrip() {
  ...
  const locationFirstPart = destinationData.location?.split(',')[0]?.toLowerCase() || 'rajasthan tours';
        ...
        >
          ...
          <div className="absolute inset-0 z-0" style={{ clipPath: 'polygon(0 0, 100% 0, 100% 85%, 0 100%)' }}>
            <img
              ...
              onError={(e) => {
                e.target.src = 'https://images.unsplash.com/photo-1532375810709-75b1da00537c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2410&q=80';
                e.target.alt = 'Rajasthan tour image placeholder';
              }}
            />
          </div>
