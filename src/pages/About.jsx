          ...
          <div className="grid lg:grid-cols-2 gap-28 items-center max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="pt-8 animate-fadeInRight" style={{ animationDelay: '1.1s' }}>
                <button className="group bg-black text-white px-8 py-2 rounded-full font-medium text-lg hover:bg-gray-800 transition-all duration-300 flex items-center space-x-3 shadow-lg hover:shadow-xl transform hover:-translate-y-1">
