  ...
  const packages = [
    {
      ...
      price: "$1599",
      image: "https://ik.imagekit.io/qad3x0vr1/Explore%20tiles/pexels-sanjeev-maurya-1172834340-21617942.jpg"
    },
    {
      id: 2,
      title: "Andaman and Nicobar",
      route: "andaman-and-nicobar",
      location: "Andaman Islands, India",
      duration: "6 Days, 5 Nights",
      price: "$1399",
      image: "https://ik.imagekit.io/qad3x0vr1/Explore%20tiles/pexels-photo-14313849.webp"
    },
    {
      id: 3,
      title: "Daman and Diu",
      ...
      price: "$899",
      image: "https://ik.imagekit.io/qad3x0vr1/Explore%20tiles/pexels-photo-14916666.webp"
    },
    {
      id: 4,
      title: "Majuli Island",
      ...
      duration: "4 Days, 3 Nights",
      price: "$999",
      image: "https://ik.imagekit.io/qad3x0vr1/Explore%20tiles/pexels-photo-103875.jpeg"
    },
    {
      id: 5,
      title: "Divar Island",
      ...
      price: "$799",
      image: "https://ik.imagekit.io/qad3x0vr1/Explore%20tiles/pexels-photo-4542265.jpeg"
    }
  ];

  const handlePackageClick = (route) => {
    navigate(`/tours/island-of-india/${route}`);
  };
      ...
      <section className="relative mt-[5rem] min-h-[50vh] flex mb-[4rem] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-8 max-w-4xl mx-auto">
          <h1 className="text-6xl md:text-8xl font-normal mb-8 flex flex-wrap justify-center items-baseline">
            <span className="block animate-gentleFadeInLeft">Island</span>
            <span className="block animate-softPulse mx-2 md:mx-4">of</span>
            <span className="block italic font-serif animate-gentleFadeInRight">India</span>
          </h1>
        </div>
      </section>
